...
FSaisieNom, FJeu, FResultat : TR_Fenetre;
-- l'application comporte 3 fenetres
Compteur : Natural;
Touche : Character;
I, J : Natural;
...
-- retour chariot
begin
  -- on initialise l'interface graphique (a ne faire qu'une fois en début de programme)
  InitialiserFenetres;
      ...
      begin
        ...
        if compteur < 3 then
          ...
          if compteur = 3 then -- C'est gagné !!!
            ...
            HeureFin:= clock;
            ChangerTexte(Fjeu,"message2","BRAVO !!! tu as gagne en" & natural'image(natural(Heurefin-HeureDeb))& "''");
